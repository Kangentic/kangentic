...
- **A list of changed source files** - verify only anchors whose source file appears in the list (used by `/sync-docs`, `/pull-request`, `/merge-pull-request`, and `/merge-back`)
