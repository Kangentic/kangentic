...
of them already inside `.vite/build/**`. Measured on 0.41.0: 318 production packages resolved
where 126 were needed, 192 packages and about 152 MB of node_modules copied into the asar for
