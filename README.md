...
- **Customizable Workflows** -- Set permission modes, auto-commands, and transition actions per column. Build pipelines like Plan, Execute, Review automatically.
...
- **Cross-Platform & Local** -- Runs entirely on your desktop -- Windows, macOS, Linux, and WSL. No cloud service, no data leaves your machine.
...
- [Configuration](docs/configuration.md) -- All settings and config cascade
