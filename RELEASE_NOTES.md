...
- **Crash and error reporting.** Kangentic now reports crashes through Sentry alongside the existing anonymous usage events. Stack traces have machine-specific paths stripped, and no task content, code, or personal data is attached.
