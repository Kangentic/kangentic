...
import { loadDemoChanges, loadDemoEnds, loadDemoOpenFrames, loadDemoPeeks, loadDemoPeekTimelines, loadDemoRecordings, loadDemoScrollback, readLiveTailMs, type DemoRecordingEntry } from '../tests/captures/helpers/demo-scrollback';
...
function buildSeedScript(version: string): string {
  ...
  return [
    ...
    buildDemoPreConfig({ scrollback, changes, peeks, ends, openFrames, peekTimelines: loadDemoPeekTimelines(), liveTailMs: readLiveTailMs(), appVersion: version }),
    '};',
