...
- `terminal.*` (shell, font size, font family, scrollback lines, cursor style, panel height, show preview, colors - the whole namespace is global-only)
