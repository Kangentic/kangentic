...
The panel persists its expanded/collapsed state, selected file, selected commit, whether the rail's History section is expanded, and the divider positions across dialog reopens. Those are per-task; the View options above are app-wide.
