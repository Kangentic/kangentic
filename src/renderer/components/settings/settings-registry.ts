...
export const SETTINGS_REGISTRY: SettingDefinition[] = [
  ...
  // ── Behavior > Terminal ──
  { id: 'terminalBlockCopy', tabId: 'behavior', label: 'Copyable Blocks', description: 'Hover a quote, code, or message block in the terminal to highlight it and copy its clean content (via the copy button or the right-click menu). Off by default; plain text selection is the simpler default.', scope: 'global', section: 'Terminal', keywords: ['copy', 'block', 'code', 'quote', 'message', 'clipboard', 'highlight', 'hover', 'terminal', 'output'] },
