...
export const SETTINGS_REGISTRY: SettingDefinition[] = [
  ...
  { id: 'git.prBypassCountsAsReady', tabId: 'git', label: 'Count merge bypass as ready', description: 'Show a PR as ready when your bypass clears a missing review, never past a failing or unfinished check.', scope: 'project', keywords: ['github', 'admin', 'bypass', 'review', 'ready', 'blocked', 'branch protection', 'pull request', 'pr'] },
