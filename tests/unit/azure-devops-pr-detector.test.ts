...
const AZURE_PR_URL = 'https://dev.azure.com/my-org/My%20Project/_git/my-repo/pullrequest/1343';
...
describe('azureDevOpsPRConnector.extract', () => {
  ...
  it('finds a PR URL on the legacy visualstudio.com host', () => {
    const legacy = 'https://my-org.visualstudio.com/My%20Project/_git/my-repo/pullrequest/1343';
    expect(azureDevOpsPRConnector.extract(legacy)?.number).toBe(1343);
  });

  it('returns the LAST match, which is the most recent', () => {
    const scrollback = `${AZURE_PR_URL}\nlater\nhttps://dev.azure.com/my-org/My%20Project/_git/my-repo/pullrequest/1350`;
