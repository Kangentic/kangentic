...
describe('prNumberFromUrl', () => {
  ...
  it('reads an Azure DevOps /pullrequest/<n> URL', () => {
    expect(
      prNumberFromUrl('https://dev.azure.com/my-org/My%20Project/_git/my-repo/pullrequest/1343'),
    ).toBe(1343);
  });

  it('reads a legacy visualstudio.com Azure PR URL', () => {
    expect(
      prNumberFromUrl('https://my-org.visualstudio.com/My%20Project/_git/my-repo/pullrequest/1343'),
    ).toBe(1343);
  });
  ...
  it('returns null for a repo URL carrying no PR', () => {
    expect(prNumberFromUrl('https://dev.azure.com/my-org/My%20Project/_git/my-repo')).toBeNull();
  });
